...
public final class Constants {
    ...
    static final String OTA_URL = "https://raw.githubusercontent.com/PixelExperiencePlus/ota/%s/%s.json";
    static final String OTA_CI_URL = "https://raw.githubusercontent.com/PixelExperiencePlus/ota/%s-ci/%s.json";
    static final String MAINTAINER_URL = "https://github.com/PixelExperiencePlus";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/PixelExperiencePlus/ota/%s/changelog_%s.md";
